...
namespace MaintenanceSheduleSystem.Persistence.Migrations
{
    ...
    [Migration("20240912081738_OrderEntityFix")]
            ...
            modelBuilder.Entity("MaintenanceSheduleSystem.Persistence.Entities.AdministratorEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bd6ed98b-f839-4a0a-9069-cf5ca1dd56cd"),
                            Email = "test@domain.ru",
                            FullName = "surname name lastname",
                            HashedPassword = "$2a$11$d0Iq16lDZtdGB4P0Vlc4g..4/VmghixmHZfT7eo/PpeosDRxe4wLy",
                            IsSacked = false,
                            Role = 1,
                            SigningKey = ""
                        });
